...
clear all;
*************************************************************;
* Replication program for Chapter 9;
*************************************************************;
log using ch9.log,replace;
***********************************;
* Read In Data; 
* (Note: Change path name so that it is appropriate for your computer);
use "/Users/mwatson/Dropbox/TB/4E/WebSupplements/ForStudents/SW_4E_ReplicationFiles/Replication_Data/mcas.dta";
*;
...
* --- Table 8.2 Results .... repeated here ;
** col(2);
reg testscr str el_pct meal_pct loginc, r;
** col(7);
